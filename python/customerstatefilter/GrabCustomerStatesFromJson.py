...
with open('C:\\Users\\jesse\\Documents\\Tools\\ToolsJesse\\python\\response.json', 'r') as jsonfile:
...
for state in data["customerStates"]:
    ...
    if (state["providingCompanyCustomerId"].startswith('000')) and not(len(state["providingCompanyCustomerId"]) < 6):
...
if filtered_data:
    with open('C:\\Users\\jesse\\Documents\\Tools\\ToolsJesse\\python\\filtered_data.csv', 'w', newline='') as csvfile:
